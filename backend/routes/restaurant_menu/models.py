...
api = Namespace('restaurantMenu', description='APIs for Restaurants')
...
post_item_req_parser.add_argument('is_available', type=bool, required=True, help='Menu item availability (true/false)')
...
update_item_req_parser.add_argument('is_available', type=bool, required=False, help='Menu item availability (true/false)')
